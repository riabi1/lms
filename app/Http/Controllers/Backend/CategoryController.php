...
class CategoryController extends Controller
{
    ...
    {
        $this->middleware(['auth:admin', 'verified']); // Ensure only admins access admin-specific methods
    }

    // Existing Category Methods (unchanged)
    ...
    // Existing SubCategory Methods (unchanged)
    ...
    // New Method for Instructor AJAX Request
