                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" class="pt-4" action="{{ route('login') }}">
                            ...
                            <div class="d-flex flex-wrap align-items-center pb-4">
                                <a href="{{ route('social.google.redirect') }}" class="btn theme-btn flex-grow-1 mx-2 mb-2">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('email') is-invalid @enderror" id="email" type="email" name="email" value="{{ old('email') }}" placeholder="Email">
                            ...
                            <div class="input-box">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control form--control password-field @error('password') is-invalid @enderror" type="password" id="password" name="password" placeholder="Password">
