    ...
    <div class="hero-slider-item hero-bg-2">
      <div class="container">
        <div class="hero-content text-center">
          <div class="section-heading">
            <h2 class="section__title text-white fs-65 lh-80 pb-3">Join EdaaLearning & Get <br> Free Courses!</h2>
      ...
      <div class="container">
        <div class="hero-content text-right">
          <div class="section-heading">
            ...
            <p class="section__desc text-white pb-4">Access a world of knowledge on your schedule. Learn new skills and expand your horizons wherever you are.</p>
          </div>
