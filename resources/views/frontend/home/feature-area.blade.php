<section class="feature-area pb-90px">
    <div class="container">
        <div class="row feature-content-wrap justify-content-center">
            <div class="col-lg-4 responsive-column-half text-center">
                <div class="info-box">
                    <div class="info-overlay"></div>
                    <div class="icon-element mx-auto shadow-sm d-flex justify-content-center align-items-center">
                    ...
                    <h3 class="info__title">Interactive Courses</h3>
                    <p class="info__text">Engage with dynamic, multimedia-rich courses designed to enhance learning.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half text-center">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Seamless Collaboration</h3>
                    <p class="info__text">Connect with peers and instructors through integrated communication tools.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half text-center">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Earn Certifications</h3>
                    <p class="info__text">Complete courses and receive recognized certifications to boost your career.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
    </div><!-- end container -->
