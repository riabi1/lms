@php
// Fetch bestseller courses, default to empty collection if null
...
<style>
/* CSS Variables for Theme Colors (consistent with header and other sections) */
:root {
    --bg-light: #ffffff;
    --bg-dark: #1a1a1a;
