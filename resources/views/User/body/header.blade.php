                ...
                <ul class="dropdown-menu dropdown-menu-end" id="userDropdown">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="dashboard-purchase-history.html">
                            <i class="bx bx-history fs-5 mr-2"></i>
                            <span>Purchase History</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="student-detail.html">
                            <i class="bx bx-user fs-5 mr-2"></i>
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="d-inline">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#"
                               onclick="event.preventDefault(); this.closest('form').submit();">
                                <i class="bx bx-log-out fs-5 mr-2"></i>
                                <span>Logout</span>
                            </a>
                        </form>
                    </li>
