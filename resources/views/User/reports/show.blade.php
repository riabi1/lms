...
@section('userdashboard')
    <style>
        .page-content .page-breadcrumb .breadcrumb .breadcrumb-item.active {
            color: #1b3324 !important;
        }
    </style>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="{{ route('dashboard') }}" class="text-decoration-none"><i class="bx bx-home-alt me-1"></i>Home</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="{{ route('report.index') }}" class="text-decoration-none">My Reports</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Report Details</li>
                </ol>
            </nav>
            <div class="ms-auto">
                <a href="{{ route('report.index') }}" class="btn btn-outline-secondary px-4">Back to Reports</a>
            </div>
        </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <dl class="row g-2">
                            ...
                            <dt class="col-4 fw-medium">Category:</dt>
                            <dd class="col-8">{{ $report->reportCategory->name ?? 'N/A' }}</dd>
                ...
                @if (in_array($report->status, ['fixed', 'not_fixed']) && !$report->feedback)
                    <div class="row mt-5">
                        <div class="col-12">
                            ...
                            <form action="{{ route('reports.feedback', $report->id) }}" method="POST" class="p-4 bg-light rounded-3">
                                @csrf
                                <div class="mb-3">
