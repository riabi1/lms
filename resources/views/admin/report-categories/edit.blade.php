      ...
      <form action="{{ route('admin.report-categories.update', $reportCategory) }}" method="POST">
        ...
        <div class="mb-3">
          <div class="form-check">
            <input type="checkbox" name="is_active" id="is_active" class="form-check-input" value="1" {{ old('is_active', $reportCategory->is_active) ? 'checked' : '' }}>
