              ...
              <div class="card-body p-sm-5">
                <div class="">
                  ...
                  <div class="text-center mb-4">
                    <h5 class="">Admin Change Password</h5>
                    <p class="mb-0">Set a new password for your account</p>
                  </div>
                  <div class="form-body">
                    <form class="row g-3" method="POST" action="{{ route('admin.password.update') }}">
                      @csrf
                      ...
                      <div class="col-12">
                        <div class="text-center">
                          <p class="mb-0">Back to <a href="{{ route('admin.login') }}">Login</a></p>
                        </div>
                      </div>
                    </form>
                  </div>
