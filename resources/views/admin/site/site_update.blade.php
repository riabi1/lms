    ...
    <div class="card shadow-lg border-0 rounded-4">
        ...
        <div class="card-body p-4">
            ...
            <form id="siteSettingsForm" action="{{ route('admin.site.update') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                @method('POST') <!-- Not strictly needed since it's POST, but kept for clarity -->
                ...
                <div class="col-md-6">
                    <img id="showImage" src="{{ $site->logo ? asset($site->logo) : asset('images/default-logo.png') }}" 
                         alt="Site Logo" class="rounded-circle p-1 border bg-light" width="80" height="80">
                </div>
