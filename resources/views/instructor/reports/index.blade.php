...
@section('title', 'My Reports | Easy Learning')
...
@section('instructor')
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a href="{{ route('instructor.reports.create') }}" class="btn btn-primary px-5">Submit New Report</a>
            </div>
        </div>
                        ...
                        <tbody>
                            @forelse ($reports as $index => $report)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('instructor.reports.show', $report->id) }}" class="btn btn-info btn-sm px-4">View</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
