...
<head>
  ...
  <title>Instructor Forgot Password</title>
</head>
        ...
        <div class="row g-0">
          ...
          <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
            <div class="card shadow-none bg-transparent rounded-0 mb-0">
              <div class="card-body">
                <img src="{{ asset('backend/assets/images/login-images/forgot-password-cover.svg') }}" class="img-fluid auth-img-cover-login" width="650" alt="" />
              </div>
            </div>
          </div>
            ...
            <div class="card rounded-0 m-3 shadow-none bg-transparent mb-0">
              <div class="card-body p-sm-5">
                <div class="">
                  ...
                  <div class="form-body">
                    <form class="row g-3" method="POST" action="{{ route('instructor.password.email') }}">
                      @csrf
                      ...
                      <div class="col-12">
                        <div class="text-center">
                          <p class="mb-0">Remember your password? <a href="{{ route('instructor.login') }}">Login here</a></p>
                        </div>
                      </div>
                    </form>
                  </div>
