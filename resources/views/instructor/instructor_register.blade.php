...
@section('home')
@section('title')
Instructor Register | Easy Learning
@endsection
  ...
  <div class="container">
    <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
      <div class="section-heading">
        <h2 class="section__title text-white">Instructor Sign Up</h2>
      </div>
    ...
    <div class="row">
      <div class="col-lg-7 mx-auto">
        <div class="card card-item">
          <div class="card-body">
            <h3 class="card-title text-center fs-24 lh-35 pb-4">Create an Instructor Account and <br> Start Teaching!</h3>
            <div class="section-block"></div>

            <form method="POST" class="pt-4" action="{{ route('instructor.register') }}">
              @csrf
              ...
              <div class="input-box">
                ...
                <div class="form-group">
                  <input class="form-control form--control" id="name" type="text" name="name" placeholder="Instructor name">
              ...
              <div class="input-box">
                ...
                <div class="form-group">
                  <input class="form-control form--control" id="email" type="email" name="email" placeholder="Instructor email">
              ...
              <div class="btn-box">
                ...
                <button class="btn theme-btn" type="submit">Register Instructor Account <i class="la la-arrow-right icon ml-1"></i></button>
                <p class="fs-14 pt-2">Already have an instructor account? <a href="{{ route('instructor.login') }}" class="text-color hover-underline">Log in</a></p>
              </div><!-- end btn-box -->
            </form>
          </div><!-- end card-body -->
        </div><!-- end card -->
