...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('instructor.coupon.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf

                <!-- Coupon Name -->
                <div class="form-group col-md-6">
                    <label for="coupon_name" class="form-label">Coupon Name</label>
                    <input type="text" name="coupon_name" class="form-control @error('coupon_name') is-invalid @enderror" id="coupon_name" value="{{ old('coupon_name') }}" required>
                    @error('coupon_name')
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" name="coupon_discount" class="form-control @error('coupon_discount') is-invalid @enderror" id="coupon_discount" value="{{ old('coupon_discount') }}" min="0" max="100" required>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="coupon_validity" class="form-control @error('coupon_validity') is-invalid @enderror" id="coupon_validity" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}" value="{{ old('coupon_validity') }}" required>
