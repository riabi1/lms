...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('instructor.update.course') }}" method="post" class="row g-3" enctype="multipart/form-data">
                @csrf
...
<div class="page-content">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('instructor.update.course.image') }}" method="post" enctype="multipart/form-data">
                @csrf
...
<div class="page-content">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('instructor.update.course.video') }}" method="post" enctype="multipart/form-data">
                @csrf
...
<div class="page-content">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('instructor.update.course.goal') }}" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $course->id }}">
