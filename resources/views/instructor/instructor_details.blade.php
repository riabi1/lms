                    ...
                    <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_{{ $course->id }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @else
                                    <p class="card-price text-black font-weight-bold">${{ number_format($course->discount_price, 2) }} <span class="before-price font-weight-medium">${{ number_format($course->selling_price, 2) }}</span></p>
                                @endif
