...
<div class="page-content">
    ...
    <div class="card shadow-sm">
        <div class="card-body p-4">
            <h5 class="mb-4 text-primary">Create Blog Post</h5>
            <form id="myForm" action="{{ route('instructor.blog.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea name="content" class="form-control" id="content" rows="5" placeholder="Write your post content...">{{ old('content') }}</textarea>
                    @error('content')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    <img id="showImage" src="{{ asset('upload/no_image.jpg') }}" alt="Preview" class="img-fluid rounded p-1 border" style="max-width: 150px; max-height: 150px; object-fit: cover;">
                </div>

                <div class="col-md-6">
                    <video id="showVideo" class="img-fluid rounded p-1 border" style="max-width: 150px; max-height: 150px; display: none;" controls>
