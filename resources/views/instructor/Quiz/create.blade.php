...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <a href="{{ route('instructor.quiz.index') }}" class="btn btn-secondary px-5">Back to Quizzes</a>
        </div>
    </div>
    <!-- End Breadcrumb -->
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="quizForm" action="{{ route('instructor.quiz.store') }}" method="POST">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select name="course_id" id="course_id" class="form-control @error('course_id') is-invalid @enderror" required>
                            ...
                            @foreach ($courses as $courseItem)
                                <option value="{{ $courseItem->id }}" {{ old('course_id', $course->id ?? '') == $courseItem->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" 
                               value="{{ old('title') }}" placeholder="Enter quiz title" required>
                        @error('title')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" 
                              rows="3" placeholder="Describe the quiz">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" name="time_limit" id="time_limit" class="form-control @error('time_limit') is-invalid @enderror" 
                           value="{{ old('time_limit') }}" min="1" max="1440" placeholder="e.g., 30">
                    @error('time_limit')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div id="questions">
                    <h5>Questions</h5>
                    <div class="question-block mb-3 p-3 border rounded" data-index="0">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h6>Question 1</h6>
                            <button type="button" class="btn btn-sm btn-danger" onclick="removeQuestion(this)" disabled>Remove</button>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Question Text <span class="text-danger">*</span></label>
                            <input type="text" name="questions[0][question_text]" class="form-control @error('questions.0.question_text') is-invalid @enderror" 
                                   value="{{ old('questions.0.question_text') }}" placeholder="Enter the question" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="questions[0][options]" class="form-control @error('questions.0.options') is-invalid @enderror" 
                                   value="{{ old('questions.0.options') }}" placeholder="e.g., Option 1, Option 2, Option 3" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="questions[0][correct_answer]" class="form-control @error('questions.0.correct_answer') is-invalid @enderror" 
                                   value="{{ old('questions.0.correct_answer') }}" placeholder="e.g., Option 1" required>
    ...
    $(document).ready(function() {
        $('#quizForm').validate({
            rules: {
                ...
                'questions[0][question_text]': { required: true, maxlength: 500 },
                'questions[0][options]': { required: true },
                'questions[0][correct_answer]': { required: true }
            },
            messages: {
                ...
                'questions[0][question_text]': { required: "Please enter the question text", maxlength: "Question text cannot exceed 500 characters" },
                'questions[0][options]': "Please provide at least one option",
                'questions[0][correct_answer]': "Please specify the correct answer"
            },
            errorElement: 'div',
